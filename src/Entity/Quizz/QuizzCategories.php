...
#[ORM\Entity(repositoryClass: QuizzCategoriesRepository::class)]
class QuizzCategories
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToMany(targetEntity: Quizz::class, mappedBy: 'categorie')]
